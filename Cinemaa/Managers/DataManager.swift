...
class DataManager {
    ...
    let filmVC: [String: TimeVCModel] = [
        "Бойцовский клуб":
            TimeVCModel(description: "Терзаемый хронической бессонницей и отчаянно пытающийся вырваться из мучительно скучной жизни клерк встречает некоего Тайлера Дардена, харизматического торговца мылом с извращенной философией. Тайлер уверен, что самосовершенствование — удел слабых, а саморазрушение — единственное, ради чего стоит жить.", today: [TimeModel(time: "14:40", price: 240), TimeModel(time: "18:50", price: 320)], tomorrow: [TimeModel(time: "10:00", price: 120)]),
        "Побег из Шоушенка": TimeVCModel(description: "Бухгалтер Энди Дюфрейн обвинён в убийстве собственной жены и её любовника. Оказавшись в тюрьме под названием Шоушенк, он сталкивается с жестокостью и беззаконием, царящими по обе стороны решётки. Каждый, кто попадает в эти стены, становится их рабом до конца жизни. Но Энди, обладающий живым умом и доброй душой, находит подход как к заключённым, так и к охранникам, добиваясь их особого к себе расположения.", today: [TimeModel(time: "10:10", price: 140),     TimeModel(time: "12:30", price: 200), TimeModel(time: "16:00", price: 250)], tomorrow: [TimeModel(time: "16:40", price: 250), TimeModel(time: "19:10", price: 310), TimeModel(time: "22:00", price: 360)]),
        "Джентельмены": TimeVCModel(description: "Бухгалтер Энди Дюфрейн обвинён в убийстве собственной жены и её любовника. Оказавшись в тюрьме под названием Шоушенк, он сталкивается с жестокостью и беззаконием, царящими по обе стороны решётки. Каждый, кто попадает в эти стены, становится их рабом до конца жизни. Но Энди, обладающий живым умом и доброй душой, находит подход как к заключённым, так и к охранникам, добиваясь их особого к себе расположения.", today: [TimeModel(time: "8:00", price: 100)], tomorrow: [TimeModel(time: "9:00", price: 140), TimeModel(time: "11:20", price: 190)]),
        "Американская история X": TimeVCModel(description: "Лидер местной банды скинхэдов Дерек Виньярд прочно удерживает авторитет в своем районе. Убежденный в своей правоте, он беспощадно расправляется с теми, кто имеет не белый цвет кожи. Независимость и смелость Дерека вызывают восхищение у его младшего брата Дэнни, который уже тоже сделал свой выбор.", today: [TimeModel(time: "12:00", price: 200), TimeModel(time: "15:50", price: 240)], tomorrow: [TimeModel(time: "19:30", price: 320)]),
        "Карты, деньги, 2 ствола": TimeVCModel(description: "Четверо молодых парней накопили каждый по 25 тысяч фунтов, чтобы один из них мог сыграть в карты с опытным шулером и матерым преступником, известным по кличке Гарри-Топор. Парень в итоге проиграл 500 тысяч, на уплату долга ему дали неделю.", today: [TimeModel(time: "10:30", price: 150), TimeModel(time: "12:00", price: 210), TimeModel(time: "22:30", price: 340)], tomorrow: [TimeModel(time: "17:00", price: 210), TimeModel(time: "19:10", price: 340), TimeModel(time: "23:40", price: 410)]),
        "Остров проклятых": TimeVCModel(description: "Два американских судебных пристава отправляются на один из островов в штате Массачусетс, чтобы расследовать исчезновение пациентки клиники для умалишенных преступников. При проведении расследования им придется столкнуться с паутиной лжи, обрушившимся ураганом и смертельным бунтом обитателей клиники.", today: [TimeModel(time: "16:00", price: 210), TimeModel(time: "18:50", price: 320)], tomorrow: [TimeModel(time: "11:00", price: 170), TimeModel(time: "19:20", price: 300)]),
        "Довод": TimeVCModel(description: "Главный герой — секретный агент, который проходит жестокий тест на надежность и присоединяется к невероятной миссии. От ее выполнения зависит судьба мира, а для успеха необходимо отбросить все прежние представления о пространстве и времени.", today: [TimeModel(time: "18:00", price: 290), TimeModel(time: "21:30", price: 350)], tomorrow: [TimeModel(time: "12:50", price: 250)]),
        "Интерстеллар": TimeVCModel(description: "Наше время на Земле подошло к концу, команда исследователей берет на себя самую важную миссию в истории человечества; путешествуя за пределами нашей галактики, чтобы узнать есть ли у человечества будущее среди звезд.", today: [TimeModel(time: "13:30", price: 230), TimeModel(time: "17:20", price: 210), TimeModel(time: "20:30", price: 270)], tomorrow: [TimeModel(time: "15:00", price: 240), TimeModel(time: "19:00", price: 340)])
    ]
}
