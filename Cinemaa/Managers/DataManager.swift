    ...
    let filmVC: [String: TimeVCModel] = [
        "Бойцовский клуб":
            TimeVCModel(
                ...
                today: [TimeModel(time: "14:40", price: 240),
                        TimeModel(time: "18:50", price: 320)],
                tomorrow: [TimeModel(time: "10:00", price: 120)],
                image: ["https://static1.colliderimages.com/wordpress/wp-content/uploads/2019/10/fight-club-brad-pitt-social.jpg?q=50&fit=contain&w=750&h=375&dpr=1.5", "https://citaty.info/files/portraits/tyler-durden-narrator-fight-club-02.jpeg", "https://images.vanityfair.it/wp-content/uploads/2019/08/31203057/Fight-Club_Land.jpg", "https://www.meme-arsenal.com/memes/6bab8c6faf7e12aecce5ad912670e1db.jpg"]),
        "Побег из Шоушенка":
            TimeVCModel(
                description: "Бухгалтер Энди Дюфрейн обвинён в убийстве собственной жены и её любовника. Оказавшись в тюрьме под названием Шоушенк, он сталкивается с жестокостью и беззаконием, царящими по обе стороны решётки. Каждый, кто попадает в эти стены, становится их рабом до конца жизни. Но Энди, обладающий живым умом и доброй душой, находит подход как к заключённым, так и к охранникам, добиваясь их особого к себе расположения.",
                today: [TimeModel(time: "10:10", price: 140),
                        TimeModel(time: "12:30", price: 200),
                        TimeModel(time: "16:00", price: 250)],
                tomorrow: [TimeModel(time: "16:40", price: 250),
                           TimeModel(time: "19:10", price: 310),
                           TimeModel(time: "22:00", price: 360)],
                image: ["https://avatars.mds.yandex.net/get-ott/1672343/2a0000016b03d1f5365474a90d26998e2a9f/1344x756", "https://static3.coolconnections.ru/images/11582/standard/hd/5f7029b20e7d0631959782c87babba3b892acaba.jpg?1569233887", "https://www.film.ru/sites/default/files/images/280498_full.jpg", "https://click-or-die.ru/app/uploads/2018/09/ps3.jpg"]),
        "Джентельмены":
            TimeVCModel(
                ...
                today: [TimeModel(time: "8:00", price: 100)],
                tomorrow: [TimeModel(time: "9:00", price: 140),
                           TimeModel(time: "11:20", price: 190)],
                image: ["https://b1.filmpro.ru/c/823212.700xp.jpg",
        ...
        "Американская история X":
            TimeVCModel(
                description: "Лидер местной банды скинхэдов Дерек Виньярд прочно удерживает авторитет в своем районе. Убежденный в своей правоте, он беспощадно расправляется с теми, кто имеет не белый цвет кожи. Независимость и смелость Дерека вызывают восхищение у его младшего брата Дэнни, который уже тоже сделал свой выбор.",
                today: [TimeModel(time: "12:00", price: 200),
                        TimeModel(time: "15:50", price: 240)],
                tomorrow: [TimeModel(time: "19:30", price: 320)],
                image: ["https://i.ytimg.com/vi/gjx9_UN4i6M/maxresdefault.jpg",
        ...
        "Карты, деньги, 2 ствола":
            TimeVCModel(
                ...
                today: [TimeModel(time: "10:30", price: 150),
                        TimeModel(time: "12:00", price: 210),
                        TimeModel(time: "22:30", price: 340)],
                tomorrow: [TimeModel(time: "17:00", price: 210),
                           TimeModel(time: "19:10", price: 340),
                           TimeModel(time: "23:40", price: 410)],
                image: ["https://avatars.mds.yandex.net/get-ott/224348/2a00000162250eeb865b8f969cca0323b422/1344x756",
        ...
        "Остров проклятых":
            TimeVCModel(
                ...
                today: [TimeModel(time: "16:00", price: 210),
                        TimeModel(time: "18:50", price: 320)],
                tomorrow: [TimeModel(time: "11:00", price: 170),
                           TimeModel(time: "19:20", price: 300)],
                image: ["https://nedelya40.ru/wp-content/uploads/2020/06/a043d08784f871e307eb.jpg",
        ...
        "Довод":
            TimeVCModel(
                ...
                today: [TimeModel(time: "18:00", price: 290),
                        TimeModel(time: "21:30", price: 350)],
                tomorrow: [TimeModel(time: "12:50", price: 250)],
                image: ["https://avatars.mds.yandex.net/get-kinopoisk-post-img/1345014/2a7d65e11819b89d3bf4206a71f69ed9/960x540",
        ...
        "Интерстеллар":
            TimeVCModel(
                ...
                today: [TimeModel(time: "13:30", price: 230),
                        TimeModel(time: "17:20", price: 210),
                        TimeModel(time: "20:30", price: 270)],
                tomorrow: [TimeModel(time: "15:00", price: 240),
                           TimeModel(time: "19:00", price: 340)],
                image: ["https://b1.filmpro.ru/c/259575.1200xp.jpg",
